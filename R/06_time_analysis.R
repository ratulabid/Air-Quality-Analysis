...
acf(airquality_clean$Ozone,
    main = "ACF of Ozone",
    col  = "pink",
    lwd  = 2)

# Observation:
# The ACF plot shows positive autocorrelation at several early lags,
# indicating that nearby Ozone observations are related to each other.
# The autocorrelation decreases as the lag increases, suggesting
# that the relationship becomes weaker for observations farther apart.
